...
live_design! {
    ...
    pub ICON_CHAT           = dep("crate://self/resources/icons/chat.svg")
    ...
    pub COLOR_NAVIGATION_TAB_BG        = #xF5F6F7
    pub COLOR_NAVIGATION_TAB_BG_HOVER  = #xF5F6F7
    pub COLOR_NAVIGATION_TAB_BG_ACTIVE = #xE8F3FF
